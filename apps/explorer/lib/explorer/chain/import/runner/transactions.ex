        ...
        from(
          ...
          update: [
            set: [
              ...
              payer_address_hash: fragment("EXCLUDED.payer_address_hash"),
          ...
          where:
            fragment(
              ...
              transaction.payer_address_hash
            )
        )
      end
